...
public class Menu extends CssLayout {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 214264930779670015L;
    ...
    public Menu(Navigator navigator) {
        ...
        top.setSpacing(true);
        Label title = new Label("Alfresco Repo");
        ...
        logoutMenu.addItem("Logout", FontAwesome.SIGN_OUT, new Command() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -1092367846539799852L;
        ...
        final Button showMenu = new Button("Menu", new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -6673043096273280315L;
    ...
    private void createViewButton(final String name, String caption,
        ...
        Button button = new Button(caption, new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -8522176447440695782L;
